    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args)
    {
        if (sender instanceof Entity)
        {
            ...
            case ENTITY:
                ...
                break;
            case MISS:
                sender.sendMessage(DaomephstaLootShared.translation(".commands.dump.target.noTarget"));
                return;
            default:
                return;
            }
            ...
            sender.sendMessage(DaomephstaLootShared.translation(".commands.dump.target.senderNotEntity"));
    }
