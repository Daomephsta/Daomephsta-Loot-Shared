...
public class SubcommandGenerate implements Subcommand
{
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args)
    {
        if (args.length < 2)
        {
            sender.sendMessage(DaomephstaLootShared.translation(".commands.generate.type"));
            return;
        }
        String type = args[1];
        if (args.length < 3)
        ...
        {
            sender.sendMessage(DaomephstaLootShared.translation(".messages.error.invalidTableName", tableId));
            return;
        }
        ...
        ResourceLocation tableId)
    {
        if (args.length < 4)
        {
            sender.sendMessage(DaomephstaLootShared.translation(".commands.generate.missingEntityId"));
            return;
        }
        ...
        if (args.length == 5)
        {
            ...
            {
                sender.sendMessage(DaomephstaLootShared.translation(".commands.generate.nbtError"));
        ...
        {
            sender.sendMessage(DaomephstaLootShared.translation(".commands.generate.invalidEntityId", id));
            return;
        }
