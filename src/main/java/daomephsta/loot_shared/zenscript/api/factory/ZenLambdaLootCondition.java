package daomephsta.loot_shared.zenscript.api.factory;
...
public class ZenLambdaLootCondition implements LootCondition
{
    ...
    @ZenRegister
    @ZenClass(DaomephstaLootShared.ZEN_PACKAGE + ".CustomLootCondition")
    @FunctionalInterface
    ...
    private static class Serialiser extends LootCondition.Serializer<ZenLambdaLootCondition>
    {
        ...
        {
            super(new ResourceLocation(DaomephstaLootShared.ID, "zen_lambda"), ZenLambdaLootCondition.class);
        }
