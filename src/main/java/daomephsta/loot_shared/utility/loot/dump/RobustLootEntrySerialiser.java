package daomephsta.loot_shared.utility.loot.dump;
...
public class RobustLootEntrySerialiser implements JsonSerializer<LootEntry>
{
    ...
    public JsonElement serialize(LootEntry entry, Type type, JsonSerializationContext context)
    {
        ...
        json.addProperty("type", DaomephstaLootShared.ID + ":best_effort");
        ...
        json.add(DaomephstaLootShared.ID + ":best_effort", bestEffort);
        return json;
    }
